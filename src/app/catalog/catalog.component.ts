...
/*same as :
 getFilteredProducts(): Product[] {
  if (this.filter === '') {
    return this.products; // Return all products if no filter is specified
  } else {
    return this.products.filter(product => product.category === this.filter); // Filter products by category
  }
}*/
}
